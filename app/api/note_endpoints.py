...
from informatica_lab4.app.auth.token_auth import verify_token
from informatica_lab4.app.controller.note_service import (
    create_note_service, get_note_service,
    get_note_info_service, update_note_service,
    delete_note_service, list_notes_service
)
from informatica_lab4.app.models.note import Note, NoteInfo, NoteCreate
...
def create_note(note: NoteCreate, authorization: str = Header(...)):
    ...
    print("Пришёл запрос с данными токена: " + token)
